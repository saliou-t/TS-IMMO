...
<head>
    ...
    <title>Modi Proprietaire</title>

</head>
<body>
    
<div class="container jumbotron px-4">
    <div class="row border py-4 my-4">
        <h3 class="text-center">TS-Immo : ajouter un proprietaire</h3> 
        <form methode="POST" action="index.php/?page=save">
            <div class="row my-3">
                <div class="col">
            ...
            <div class="row mt-5 justify-content-around">
                <div class="col text-center  ">
                    <a class="btn btn-info mx-auto w-50" href="">Enregistrer les modifications</a>
                </div>
            </div>
        </form>
    </div>
